import {Link, useOutletContext, useLoaderData, Await} from 'react-router';
...
export async function loader({context}) {
  ...
  // Defer orders query to load in parallel with parent customer query
  const ordersPromise = customerAccount.query(CUSTOMER_ORDERS_QUERY, {
    variables: {
      first: 3,
    ...
    if (errors?.length) {
      console.error('Failed to load orders:', errors);
      return [];
    }
        ...
        fallback={
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-black/50 border border-white/10 rounded-lg p-6 animate-pulse">
