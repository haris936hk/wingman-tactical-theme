  ...
  return (
    ...
    <div className="max-w-5xl">
      ...
      <div className="bg-black/50 backdrop-blur-sm border-2 border-[#FF0000]/30 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase text-white mb-3 sm:mb-4" style={{fontFamily: 'var(--font-family-shock)'}}>
          Order {order.name}
        </h1>
      ...
      {/* Order Summary */}
      <div className="bg-black/50 backdrop-blur-sm border-2 border-[#FF0000]/30 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
        <h2 className="text-xl sm:text-2xl font-bold uppercase text-white mb-4 sm:mb-6" style={{fontFamily: 'var(--font-family-shock)'}}>
          Order Summary
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div className="bg-black/50 backdrop-blur-sm border-2 border-[#FF0000]/30 rounded-lg p-4 sm:p-6">
          <h3 className="text-lg sm:text-xl font-bold uppercase text-white mb-3 sm:mb-4" style={{fontFamily: 'var(--font-family-shock)'}}>
            Shipping Address
          </h3>
