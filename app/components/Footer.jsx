          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-gray-400 text-sm">
                ...
                <a href="tel:+12026748681" className="hover:text-[#d32f2f] transition-colors">
                  Phone: +1 2026748681
                </a>
              </div>
              ...
              <div className="flex items-center gap-3 text-gray-400 text-sm">
                ...
                <a href="mailto:sales@wingmandepot.com" className="hover:text-[#d32f2f] transition-colors">
